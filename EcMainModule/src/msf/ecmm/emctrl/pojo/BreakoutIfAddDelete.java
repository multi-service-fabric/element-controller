...
@XmlRootElement(name = "breakout")
public class BreakoutIfAddDelete extends AbstractMessage {

  /** Attribute Data of Service Basic Configuration. */
  @XmlAttribute
  private String xmlns = "http://www.ntt.co.jp/msf/service/breakout";
  ...
  public String toString() {
    return "BreakoutIfAddDelete [xmlns=" + xmlns + ", name=" + name + ", device=" + device + "]";
  }
}
