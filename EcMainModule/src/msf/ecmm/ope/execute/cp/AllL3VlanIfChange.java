 ...
 *
 */
public class AllL3VlanIfChange extends Operation {
   ...
   *          URI key information
   */
  public AllL3VlanIfChange(AbstractRestMessage idt, HashMap<String, String> ukm) {
    super(idt, ukm);
    super.setOperationType(OperationType.AllL3VlanIfChange);
  }
  ...
  public AbstractResponseMessage execute() {
    ...
    try (DBAccessManager session = new DBAccessManager()) {
      ...
      L3SliceAddDelete l3SliceAddDeleteEm = EmMapper.toL3VlanIfBulkChange(inputData, nodesMap, allVlanIfsMap);
