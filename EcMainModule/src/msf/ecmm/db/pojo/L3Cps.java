...
public class L3Cps implements Serializable {
    ...
    public String toString() {
        return "L3Cps [slice_id=" + slice_id + ", cp_id=" + cp_id + ", node_type=" + node_type + ", node_id=" + node_id + ", base_physical_if_id="
