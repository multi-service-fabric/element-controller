#!/bin/bash
##
## SNMPTrap Functional Part linkdonw.sh Link Down Notification Script
##
## Shell script which is triggered by the LinkDown event notification in snmptrapd.conf
